...
MIN_CANDIDATES: int = 1  # 八叉树查询时的最小候选帧数量（约为总数的1%）
BEAM_WIDTH: int = 500  # 多分枝向下搜索时保留的候选节点数量500/7096
MAX_BACKTRACK_DEPTH: int = 4 # 候选不足时允许回溯的最大层级4/11
